 ...
 * that, call {@link GlSurfaceView#setAspectRatioMode(int)} with
 * {@link GlSurfaceView#ASPECT_RATIO_PREVIEW} after creating your
 * {@link GlSurfaceView}. <br />
 */
public class GlSurfaceView extends SurfaceView implements Runnable, OnFrameAvailableListener, SurfaceHolder.Callback {
    public final static String TAG = GlSurfaceView.class.getSimpleName();
